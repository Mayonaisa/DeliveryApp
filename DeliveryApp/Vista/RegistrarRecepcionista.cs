...
namespace DeliveryApp.Vista
{
    public partial class RegistrarRecepcionista : Form
    {
        ...
        public RegistrarRecepcionista(Panel p,Recepcionista Rec )
        {
            contenedor = p;
            Recep = Rec;
            InitializeComponent();
        }
        public RegistrarRecepcionista(Panel p, Repartidor Rep)
        {
            contenedor = p;
            Repar = Rep;
            InitializeComponent();
        ...
        private void rjButton1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Recepcionista.registrar(txtUsua.Texts, txtNom.Texts, txtApa.Texts, txtAma.Texts, tbxTelefono.Texts, dtpNacim.Value.ToString(), txtCorreo.Texts, cbxSexo.Texts, age.ToString(), tbxCont.Texts, cbxPais.Texts, cbxEst.Texts, cbxCiu.Texts, txtCalle1.Texts, txtCalle2.Texts, cbxCol.Texts, txtNumCasa.Texts));
